    ...
    return MaterialApp(
      ...
      routes: {
        '/datatable2': (context) {
          ...
          return _getScaffold(
              context, currentRouteOption == rounded ? const DataTable2RoundedDemo() : const DataTable2Demo(), getOptionsForRoute('/datatable2'));
        },
        ...
        '/datatable2resize': (context) => _getScaffold(context, const ResizableDataTable2Demo(), getOptionsForRoute('/datatable2resize')),
      },
