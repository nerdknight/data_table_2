...
void main() {
  group('DataTable2', () {
    ...
    testWidgets('Horizontal scrollbar is visible if isHorizontalScrollBarVisible=true', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester, buildTable(isHorizontalScrollBarVisible: true), const Size(250, 300));
    ...
    testWidgets('Vertical and horizontal scrollbars are visible if isHorizontalScrollBarVisible=true, isVerticalScrollBarVisible=true',
        (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester, buildTable(isVerticalScrollBarVisible: true, isHorizontalScrollBarVisible: true), const Size(250, 300));
    ...
    testWidgets('Vertical and horizontal scrollbars are visible  when using theme', (WidgetTester tester) async {
      await wrapWidgetSetSurf(
          tester,
          Theme(data: ThemeData(scrollbarTheme: ScrollbarThemeData(thumbVisibility: WidgetStateProperty.all(true))), child: buildTable()),
          const Size(250, 300));
    ...
    testWidgets('scrollController scrolls to bottom', (WidgetTester tester) async {
    ...
    testWidgets('horizontalScrollController scrolls to right', (WidgetTester tester) async {
      ...
      await wrapWidgetSetSurf(tester, buildTable(horizontalScrollController: horizontalSc, minWidth: 500), const Size(300, 500));
    ...
    testWidgets('DataRow2 renders with custom decoration', (WidgetTester tester) async {
      const BoxDecoration rowDecoration = BoxDecoration(color: Color(0xFFFFF3E0));
      ...
      expect(find.ancestor(of: find.byType(Table).first, matching: find.byType(Container).first), paints..rect(color: const Color(0xFFFFF3E0)));
    });
  });
  ...
  group('PaginatedDataTable2', () {
    ...
    testWidgets('autoRowsToHeight WITH headers AND card works fine', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester, buildPaginatedTable(showPage: false, showGeneration: false, showHeader: true, wrapInCard: true, autoRowsToHeight: true));
    ...
    testWidgets('scrollController scrolls to bottom', (WidgetTester tester) async {
      var sc = ScrollController();
      await wrapWidgetSetSurf(tester, buildPaginatedTable(scrollController: sc, showGeneration: false, showPage: false));
    ...
    testWidgets('horizontalScrollController scrolls to right', (WidgetTester tester) async {
      var horizontalSc = ScrollController();
      await wrapWidgetSetSurf(
          tester, buildPaginatedTable(horizontalScrollController: horizontalSc, minWidth: 500, showGeneration: false, showPage: false), const Size(300, 500));
    ...
    testWidgets('headingRowColor is applied', (WidgetTester tester) async {
      await wrapWidgetSetSurf(tester, buildPaginatedTable(headingRowColor: WidgetStateProperty.all(Colors.yellow)));
    ...
    testWidgets('hidePaginator hides paginator', (WidgetTester tester) async {
      await tester.binding.setSurfaceSize(const Size(1000, 300));
      await tester.pumpWidget(
          MaterialApp(home: Material(child: buildPaginatedTable(showPage: false, showGeneration: false, showPageSizeSelector: true, hidePaginator: true))));
    ...
    testWidgets('PaginatorController works', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
          MaterialApp(home: Material(child: buildPaginatedTable(showPage: false, showGeneration: false, showPageSizeSelector: true, controller: controller))));
  ...
  group('AsyncPaginatedDataTable2', () {
    ...
    testWidgets('scrollController scrolls to bottom', (WidgetTester tester) async {
      var sc = ScrollController();
      await wrapWidgetSetSurf(tester, buildAsyncPaginatedTable(scrollController: sc, showGeneration: false, showPage: false));
    ...
    testWidgets('horizontalScrollController scrolls to right', (WidgetTester tester) async {
      var horizontalSc = ScrollController();
      await wrapWidgetSetSurf(tester, buildAsyncPaginatedTable(horizontalScrollController: horizontalSc, minWidth: 500, showGeneration: false, showPage: false),
          const Size(300, 500));
    ...
    testWidgets('PaginatorController works', (WidgetTester tester) async {
      ...
      var controller = PaginatorController();
      await tester.pumpWidget(MaterialApp(
          home: Material(child: buildAsyncPaginatedTable(showPage: false, showGeneration: false, showPageSizeSelector: true, controller: controller))));
    ...
    testWidgets('Custom loading spinner is shown', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          home: Material(
              child:
                  buildAsyncPaginatedTable(showPage: false, showGeneration: false, showPageSizeSelector: true, circularSpinner: true, hidePaginator: true))));
    ...
    testWidgets('Switching page shows loading spinner', (WidgetTester tester) async {
      await tester.binding.setSurfaceSize(const Size(1000, 300));
      await tester
          .pumpWidget(MaterialApp(home: Material(child: buildAsyncPaginatedTable(showGeneration: false, showPageSizeSelector: true, hidePaginator: false))));
  ...
  testWidgets('Page switch and PageSyncApproach.goToLast', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        home: Material(
            child: buildAsyncPaginatedTable(
                showHeader: false, rowsPerPage: 5, showCheckboxColumn: false, fewerResultsAfterRefresh: true, syncApproach: PageSyncApproach.goToLast))));
  ...
  testWidgets('DataTable2 custom sort arrow widget', (WidgetTester tester) async {
    ...
    List upArrow = tester.widgetList(find.byIcon(Icons.arrow_drop_up_rounded)).toList();
    List downArrow = tester.widgetList(find.byIcon(Icons.arrow_drop_down_rounded)).toList();
    ...
    upArrow = tester.widgetList(find.byIcon(Icons.arrow_drop_up_rounded)).toList();
    downArrow = tester.widgetList(find.byIcon(Icons.arrow_drop_down_rounded)).toList();
    expect(upArrow.length, equals(1));
    expect(downArrow.length, equals(1));
  ...
  testWidgets('DataTable2 checkbox themes', (WidgetTester tester) async {
    Widget buildTable() {
      return DataTable2(
        headingCheckboxTheme: CheckboxThemeData(fillColor: WidgetStateProperty.all(Colors.red)),
        datarowCheckboxTheme: CheckboxThemeData(fillColor: WidgetStateProperty.all(Colors.yellow)),
    ...
    var h = find.byType(Theme).evaluate().where((element) =>
        ...
        (element.widget as Theme).data.checkboxTheme.fillColor!.resolve({WidgetState.hovered}) == Colors.red);
    expect(h.length, 1);
    expect((h.first.widget as Theme).child.runtimeType, Checkbox);

    var d = find.byType(Theme).evaluate().where((element) =>
        (element.widget as Theme).data.checkboxTheme.fillColor != null &&
        (element.widget as Theme).data.checkboxTheme.fillColor!.resolve({WidgetState.hovered}) == Colors.yellow);
